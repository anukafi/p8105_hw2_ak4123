...
###Questions
There are `r {count(distinct(brfss_data, locationdesc))}` unique locations included in this dataset. 
...
`r {brfss)data %>% filter(year == "2002", !is.na(excellent)) %>% summarize(median(excellent))}` was the median of the Excellent response value. 
